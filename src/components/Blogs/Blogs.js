  ...
  return (
    <Accordion className="w-10/12 m-auto pt-56 acordion-container" defaultActiveKey={["0"]} alwaysOpen>
      ...
      <Accordion.Item eventKey="2">
        <Accordion.Header>Difference between inline and inline-elements </Accordion.Header>
        <Accordion.Body>
          <strong>Block Elements:</strong> Block Elements takes the ful width of the screen and other elements have to take place from the next of it. A block element every time starts on a new line, and fills up the horizontal space left and right on the web page. We can add margins and padding on all four sides of any block element — top, right, left, and bottom.<br></br>
          <small>Example: div</small>
          <br></br>
          <strong>Inline Elements:</strong>
          Unlike the block element it dlock elements it doesn't take the whole width of the screen. Inline elements don’t start on a new line, they appear on the same line as the content and tags beside them. <br></br>
